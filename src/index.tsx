...
import { ClientSession, sessionTreeConfiguration } from "./schema/session_schema.js";
...
async function signedInSpeStart(msalInstance: PublicClientApplication, account: AccountInfo) {
	...
	const { services, container } = await loadFluidData(containerId, notesContainerSchema, client);
	...
	// Load the app
	loadApp(appTree, sessionTree, services, container);
...
async function anonymousAzureStart() {
